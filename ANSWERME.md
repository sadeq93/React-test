...
Answer - 
My app should has 3 route (Home Page,Radar Page,Bar Page) and ;
- Nav component => which is render over all pages return navigation bar with pages links .
- RankInput component => return  HTML <Label> and<input> tags.
- ModulesForm component => return number of RankInput component depending on number of modules (MODULE array ).
- Chart component => which has to type (radar,bar)
